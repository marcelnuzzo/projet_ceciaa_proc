...
function envoiMail($sujet,$objet,$cc_email,$MailDestinataires) {
	/* Exception class. */
	require 'C:\wamp64\www\Ceciaa\projet\PHPMailer\src\Exception.php';
	/* The main PHPMailer class. */
	require 'C:\wamp64\www\Ceciaa\projet\PHPMailer\src\PHPMailer.php';
	/* SMTP class, needed if you want to use SMTP. */
	require 'C:\wamp64\www\Ceciaa\projet\PHPMailer\src\SMTP.php';
	...
	try {
		...
		$mail->Username   = 'nuzzom98@gmail.com';
	    //$mail->Password   = 'marcel316497';                       // SMTP password
		$mail->Password = 'carambar3436carambar';
